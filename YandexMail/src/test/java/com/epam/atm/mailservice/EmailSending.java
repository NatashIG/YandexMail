...
public class EmailSending { // extends GeneralConditions{

        @Test
         public void EmailSendingProcess() {
                //set up
                ...
                //WebElement draftSubject = driver.findElement(By.xpath("//input[contains(@class,'mail-Compose-Field-Input-Controller')]"));
                //Assert.assertEquals(draftSubject.getText(),"Hello Stella!", "Wrong subject");

                //WebElement draftBody = driver.findElement(By.xpath("//div[@id='cke_56_contents']/textarea"));
